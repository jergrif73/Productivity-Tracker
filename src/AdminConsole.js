...
const AdminConsole = ({ db, detailers, projects, currentTheme, appId, showToast }) => {
    ...
    const [newProject, setNewProject] = useState({ name: '', projectId: '', initialBudget: 0, blendedRate: 0, vdcBlendedRate: 0, contingency: 0, dashboardUrl: '', status: 'Planning', startDate: '', projectManager: '', projectedDurationWeeks: '' });
    ...
    const handleAdd = async (type) => {
        ...
        if (type === 'employee') {
            ...
            setNewProject({ name: '', projectId: '', initialBudget: 0, blendedRate: 0, vdcBlendedRate: 0, contingency: 0, dashboardUrl: '', status: 'Planning', startDate: '', projectManager: '', projectedDurationWeeks: '' });
