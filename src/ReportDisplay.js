                        ...
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <TutorialHighlight tutorialKey="exportToCSV">
                                <div className="flex gap-2">
                                        ...
                                        <button onClick={() => exportToCSV(reportData, reportHeaders, reportType)} className="bg-green-600 text-white p-2 rounded-md hover:bg-green-700">Export to CSV</button>
                                </div>
                            </TutorialHighlight>
                        </div>
